              ...
              <li>
                <div class="col-sm-12 col-xs-12 col-md-12 facet-dropdown dropdown">
                  <a class="select-title" rel="nofollow" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <i class="material-icons float-xs-right" data-toggle="dropdown" aria-hidden="true">&#xE5C5;</i>
                  </a>
...
<script>
  (function () {
    if (window.__facetDropdownIconBound) {
      return;
    }
    window.__facetDropdownIconBound = true;
    document.addEventListener('click', function (event) {
      var icon = event.target.closest('.facet-dropdown .select-title .material-icons');
      if (!icon) {
        return;
      }
      var trigger = icon.closest('.select-title');
      if (!trigger) {
        return;
      }
      event.preventDefault();
      if (typeof jQuery !== 'undefined' && typeof jQuery(trigger).dropdown === 'function') {
        jQuery(trigger).dropdown('toggle');
      } else {
