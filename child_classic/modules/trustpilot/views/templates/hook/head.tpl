...
<script type="text/javascript" src="{/literal}{$register_js_dir}{literal}" defer></script>
<script type="text/javascript" src="{/literal}{$trustbox_js_dir}{literal}" defer></script>
<script type="text/javascript" src="{/literal}{$preview_js_dir}{literal}" defer></script>
{/literal}
